...
describe ListPage do
  ...
  it "redirects to the home page when the list is not accessible" do
    ...
    ctx = Crumble::Server::TestRequestContext.new(method: "GET", resource: ListPage.uri_path(list.id.value))
  ...
  it "renders an accessible list and stores it as last used" do
    ...
    ctx = Crumble::Server::TestRequestContext.new(response_io: response_io, method: "GET", resource: ListPage.uri_path(list.id.value))
