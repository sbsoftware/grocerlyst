class DataPrivacyNoticeView
  ToHtml.class_template do
    ...
    h4 { "Wofür nutzen wir Ihre Daten?" }
    p do
      "Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden."
    end
    h4 { "Welche Rechte haben Sie bezüglich Ihrer Daten?" }
    p do
    ...
    h2 { "2. Hosting und Content Delivery Networks (CDN)" }
    ...
    p do
      "Telefon: +49 176 69941209"
      br
      "E-Mail: kontakt@sbsoftware.de"
    end
    p do
    ...
    h3 { "Cookies" }
    p do
      "Unsere Internetseiten verwenden so genannte „Cookies“. Cookies sind kleine Textdateien und richten auf Ihrem Endgerät keinen Schaden an. Sie werden entweder vorübergehend für die Dauer einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies) auf Ihrem Endgerät gespeichert. Session-Cookies erden nach Ende Ihres Besuchs automatisch gelöscht. Permanente Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen oder eine automatische Löschung durch Ihren Webbrowser erfolgt."
    end
    p do
